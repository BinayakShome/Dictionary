...
import com.example.dictionary_2.ui.theme.Dictionary_2Theme
...
class MainActivity : ComponentActivity() {
    ...
    fun Meaning(
        ...
        Column(
            ...
            if (meaning.definition.synonyms.isNotEmpty()) {
                Spacer(modifier = Modifier.height(8.dp))
                ...
                Row(
                    ...
                    Text(
                        text = meaning.definition.synonyms,
                        fontSize = 17.sp,
                        color = MaterialTheme.colorScheme.onBackground
                    )
            ...
            if (meaning.definition.antonyms.isNotEmpty()) {
                Spacer(modifier = Modifier.height(8.dp))
